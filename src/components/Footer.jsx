...
export default function Footer() {
  return (
    <footer className="bg-amber-950 text-amber-200/80 pt-12 pb-8 border-t border-amber-900/50 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-amber-400 mb-4">Qurbani Market</h3>
            <p className="text-sm leading-relaxed max-w-md">
              Your trusted platform for sourcing premium livestock for Qurbani. We connect you with top farms across the country to ensure quality, health, and a hassle-free experience.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/animals" className="hover:text-amber-400 transition-colors">All Animals</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>📍 123 Farm Road, Dhaka</li>
              <li>📞 +880 1234 567 890</li>
              <li>✉️ support@qurbanimarket.com</li>
            </ul>
        ...
        <div className="border-t border-amber-900/50 pt-8 mt-8 text-center text-xs text-amber-500">
          <p>&copy; {new Date().getFullYear()} Qurbani Market. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
